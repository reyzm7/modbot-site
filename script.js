...
const BOUTIQUE_ARTICLES = [
  { key: "bot_essentiel", categorie: "bot", prix: 1400, delai: 3, revisions: 1,
  ...
  { key: "bot_avance", categorie: "bot", prix: 3400, delai: 7, revisions: 2, recommande: true,
  ...
  { key: "bot_pro", categorie: "bot", prix: 6900, delai: 14, revisions: 3,
  ...
  { key: "pack_serveur", categorie: "pack", prix: 9900, delai: 14, revisions: 2, recommande: true,
    ...
    points: [{ texteClef: "bq.packEnsemble" }, { texteClef: "bq.miseEnLigne" }] },
  { key: "pack_pro", categorie: "pack", prix: 21900, delai: 30, revisions: 3,
